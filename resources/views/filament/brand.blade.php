...
<div style="display: flex; flex-direction: row; align-items: center; gap: 0.5rem; white-space: nowrap;">
    ...
    <span style="font-family: 'Rajdhani', sans-serif; font-size: 1.05rem; font-weight: 600; letter-spacing: 0.06em; line-height: 1;" class="brand-logo-text">
        {{ config('app.name') }}
    </span>
